  ...
  return (
    <motion.div
      ...
      <a
        ...
        <section
          id="projects"
          className="relative bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 sm:h-[20rem] sm:group-even:pl-8 hover:bg-gray-50 transition rounded-lg">
          <div className="flex flex-col pt-4 pb-8 pl-10 pr-2 sm:pt-10 sm:max-w-[50%] h-full sm:group-even:ml-[18rem]">
