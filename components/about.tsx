    ...
    <motion.section
      ...
      <SlideReveal>
        <p className="text-md sm:text-xl">
          ...
          machine learning engineer with a strong foundation in technical
          skills, as well as research and product management. After earning my
          PhD from <span className="font-bold">Loughborough University</span>,
          where my research on evidential classification in network security led
          to
          ...
          time-series forecasting. My recent role as a Technical Product Owner
          for an IoT project allowed me to{" "}
          <span className="font-bold">
            lead embedded engineering innovations
          </span>{" "}
      ...
      <SlideReveal>
        <p className="text-md sm:text-xl">
          ...
          <span className="font-bold">project management</span>, which
          complement my proficiency in cloud computing, embedded systems, and
          programming languages like Python and C. I am known for a{" "}
          <span className="underline">hands-on approach</span> to
          problem-solving and continue to contribute to{" "}
