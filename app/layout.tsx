...
export default function RootLayout({
  ...
  return (
    <html
      ...
      <body
        className={`${geistSans.variable} ${geistMono.variable} antialiased bg-[#111111] text-white relative h-[5000px] pt-28 sm:pt-36`}>
        <div className="bg-[#6f5617] absolute top-[-6rem] -z-10 right-[11rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem]"></div>
